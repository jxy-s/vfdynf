...
AVRF_PROPERTY_DESCRIPTOR g_Descriptors[]
{
    ...
    },
    {
        ...
        L"Excludes stack from fault injection when a regular expression matches a stack fame symbol.",
        nullptr
    },
    {
        AVRF_PROPERTY_DWORD,
        ...
        L"Clears dynamic stack fault injection tracking on this period, in milliseconds, zero disables.",
        nullptr
    },
